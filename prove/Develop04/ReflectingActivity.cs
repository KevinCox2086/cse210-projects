...
public class ReflectingActivity : Activity
{
    ...
    "Think of a time when you were able to forgive someone.",
    "Think of a time when you helped someone in need.",
    "Think of a time when you did something truly selfless.",
    "Think of a time when you failed at something.",
    "Think of a time when you were able to overcome a challenge.",
    ...
    "What is something you would change about this experience?",
    ...
    {
        //creates a new list that can be destroyed each time.
        ...
        while (timer.Elapsed.TotalSeconds < seconds)
        {
            if (_useQuestionsList.Count != 0)
            {
                ...
                Console.Write($"\n>> {question}  ");
                //removes question from list so it can not be used again
